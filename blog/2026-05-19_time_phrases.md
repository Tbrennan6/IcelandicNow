...
This post will discuss the most common Icelandic time phrases. 
...
## Columns 
The columns are divided into 8 different categories: *this*, *ever**, *during the*, *in general*, *two ago*, *last*, *next*, and *in two*. A couple of these required further elaboration.

- *This* refers to the current unit that is currently being experienced.
- *During the* and *in general* are similar, and the majority of the time they are interchangeable, with the during version being fancier but more stilted. However, the former is used to give a more general, more frequent, or more normal flavor.
- *Two ago* and *in two* are categories that do not really exist in English, with limited exceptions. However, they are very frequent in Icelandic.   
