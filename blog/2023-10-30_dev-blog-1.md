...
Due to an error on my part, I lost the domain name SimpleIcelandic.com. As a result, I will no longer be using the name Simple Icelandic for my Icelandic language work. While I really liked the name, it does not make sense to use a name that you do not own the domain rights to.
