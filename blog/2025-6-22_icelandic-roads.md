...
Just like in English, there is no single word used to describe all the drivable roads in Icelandic. Instead, a varierty of semi-interchangable words are used with slight nuance coloring the use of each one. Also, there are many instances where the terms will be used more or less interchangable, or done so for flavor. 
...
## Braut
A *braut* is typically the principle road in a neighborhood. 
