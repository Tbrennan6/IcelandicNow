...
The *-di*,*-ti*, *-ði* conjugation patterns have been combined above into two tables, one for the present and one for the past.

The reason for this is that in the present tense, these three verb types inflect the exact same, while in the past tense, they differ by only a single letter. In the past tense chart, this differing letter is represented by the letter *x*. You can match the letter *x* in the table with the letter in the name of the verb type to find that verb's simple past endings.
