...
*Practice: As you should with the other patterns as well, take some time to observe the present and past tenses of each subject together and try to better appreciate how a verb changes in one person and plurality from the present into the past as well as pick out patterns in the charts more generally.*
...
*Note: Just because a verb's stem ending fits in one of the i-endings patterns, that does not automatically mean it is an i-verb (e.g., "að elska" and "að hrópa").*
